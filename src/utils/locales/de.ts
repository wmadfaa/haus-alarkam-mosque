export default {
  ...
  signIn: {
    userForm: {
      caption: 'Bitte geben Sie Ihre Daten ein, um sich anzumelden!',
      inputs: {
        firstName: {
          label: 'Vorname',
          placeholder: 'Geben Sie Ihren Vornamen ein',
          errors: {
            isRequired: 'Vorname ist erforderlich',
          },
        },
        lastName: {
          label: 'Nachname',
          ...
          errors: {
            isRequired: 'Nachname ist erforderlich',
          },
        },
        phoneNumber: {
          label: 'Telefonnummer',
          ...
          errors: {
            isRequired: 'Telefonnummer ist erforderlich',
          },
        },
        rememberMe: {
          label: 'Mich erinnern',
    ...
    termsModal: {
      header: 'Bitte stimmen Sie zu, sich anzumelden',
      terms:
  ...
  control: {
    info: {
      caption: 'Verbleib für die Freitagsgebetszeit',
    },
  },
  actions: {
